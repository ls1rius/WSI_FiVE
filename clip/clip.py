...
import sys
sys.path.append("../")
from models.FiVE import build_model
import math
...
def tokenize(texts: Union[str, List[str]], context_length: int = 77) -> torch.LongTensor:
    ...
    # L10 change
    # context_length_fix = 77 - 2
    # all_tokens = []
    # for text in texts:
    #     text_tokens = _tokenizer.encode(text)
    #     all_tokens_sep = []
    #     for i in range(math.ceil(len(text_tokens)/context_length_fix)):
    #         all_tokens_sep += ([sot_token] + text_tokens[context_length_fix*i: context_length_fix*(i+1)] + [eot_token])
    #     all_tokens.append(all_tokens_sep)
