...
def main():
    ...
    if args.dataset == "tcga-test":
        ...
        download_url('https://uwmadison.box.com/shared/static/q4d9fr93wmllf1navjf2ghc9b0pmzf2a.zip',
                     'tcga-dataset-test.zip')
        try:
    ...
    if args.dataset == "c16-test":
        ...
        download_url('https://uwmadison.box.com/shared/static/6t7qcmhv5g1a42qaxmuffpvspqzcw1aq.zip',
                     'c16-dataset-test.zip')
        try:
        ...
        download_url('https://uwmadison.box.com/shared/static/qs717clgaux5hx2mf5qnwmlsoz2elci2.zip',
                     'test-weights-c16.zip')
